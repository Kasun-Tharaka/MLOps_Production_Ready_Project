...
from visa_approval.components.data_ingestion import DataIngestion # to access the data
...
class TrainPipeline:
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        """
        TrainPipeline class is responsible for starting data ingestion component
        """
        try:
    ...
    def start_data_transformation(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_artifact: DataValidationArtifact) -> DataTransformationArtifact:
        """
        TrainPipeline class is responsible for starting data transformation component
        """
        try:
    ...
    def run_pipeline(self, ) -> None:
        """
        this is responsible for runing complete pipeline
        """
        try:

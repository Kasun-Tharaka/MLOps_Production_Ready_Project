...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        """
        this will take as inputs, data ingestion artifact and data validation config.
        """
        try:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        try:
            ...
            # check whether numerical columns are exist
            ...
            # # check whether categorical columns are exist
    ...
    # start data drift same as did in notbook

# here containf which did in feature engineering using notebook.
import sys
...
class DataTransformation:
    ...
    @staticmethod # if it is a static method, no need to call with self 
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        data transformer object is created and returned 
        """
        logging.info(
    ...
    def initiate_data_transformation(self, ) -> DataTransformationArtifact:
        ...
        data transformer steps are performed and preprocessor object is created  
        """
        try:

...
from visa_approval.entity.estimator import visa_approvalModel
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        try:
            ...
            # to neuro_mf, provide model config file path for model detais
    ...
    def initiate_model_trainer(self, ) -> ModelTrainerArtifact:
        ...
        """
        This function initiates a model trainer steps
        ...
        try:
            ...
            usvisa_model = visa_approvalModel(preprocessing_object=preprocessing_obj,
